...
| T-43 | **Injection via authored system prompt / uploaded skill** | **Medium** | C-4 | LLM01 | Partially mitigated |
...
| T-41 | **Config-driven agent deps → supply-chain / arbitrary-code in build** | **Medium** | C-12, C-17 | Tampering, Elevation of Privilege | Mitigated |
| T-42 | **Untrusted skill-package (`.zip`) ingestion** | **Medium** | C-12 | Tampering | Mitigated |
...
| **Medium (Mitigated)** | 8 | T-31, T-33, T-34, T-36, T-37, T-38, T-43, T-44 |
| **Medium (Partially mitigated)** | 1 | T-42 |
